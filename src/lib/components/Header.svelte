...
<div class="w-full bg-gray-300 bg-opacity-95 h-10 px-12">
	<div class="flex justify-between py-2 px-4">
		<div class="flex">
			...
			<span class="text-gray-700 ml-2 my-auto text-sm font-semibold">
					+263 &#40;242&#41; 412121212
			</span>
		</div>
		<div class="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
			<a href="https://www.facebook.com/uccz" class="text-blue-500">
				<svg
					fill="currentColor"
			...
			<a href="https://x.com/uccz" class="ml-3 text-blue-500">
				<svg
					fill="currentColor"
					stroke-linecap="round"
					stroke-linejoin="round"
			...
			<a href="https://www.instagram.com/uccz/" class="ml-3 text-blue-500">
				<svg
					fill="none"
					stroke="currentColor"
					stroke-linecap="round"
